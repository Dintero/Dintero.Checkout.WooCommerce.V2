jQuery(function ($) {
    ...
    const dinteroCheckoutForWooCommerce = {
            ...
            dintero
                .embed({
                    ...
                    onValidateSession(event, checkout, callback) {
                        ...
                        const totalAmount = event.session.order.amount

                        dinteroCheckoutForWooCommerce.submitOrder(callback, totalAmount)
         ...
         */
        submitOrder(callback, totalAmount) {
            this.blockForm()
            ...
            $.ajax({
                ...
                data: {
                    amount: totalAmount,
                    nonce: dinteroCheckoutParams.verify_checkout_total,
                },
                url: dinteroCheckoutParams.verify_checkout_total_url,
            ...
            if (OK) {
                ...
                dinteroCheckoutForWooCommerce.logToFile(`${dinteroCheckoutParams.SID} | bad_amount`)
                dinteroCheckoutForWooCommerce.failOrder("bad_amount", "The total amount is not correct", callback)
