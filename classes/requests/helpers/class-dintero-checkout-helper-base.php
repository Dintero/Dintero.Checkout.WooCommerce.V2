...
abstract class Dintero_Checkout_Helper_Base {
	...
	/**
	 * Retrieve the billing address mapped to the Dintero API format.
	 *
	 * @return array Associative array of billing address fields.
	 */
	...
	/**
	 * Retrieve the customer object for the Dintero API session body.
	 *
	 * Extracts email and, when present, phone_number from the billing address.
	 *
	 * @return array Associative array with 'email' and optionally 'phone_number'.
	 */
