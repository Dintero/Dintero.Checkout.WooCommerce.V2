...
class Dintero_Checkout_Cart extends Dintero_Checkout_Helper_Base {
	...
	public function get_shipping_item( $shipping_rate ) {
		...
		$description = $this->get_shipping_method_option( $shipping_rate, 'dintero_description' );
	...
	private function get_pickup_point( $shipping_rate, $pickup_point ) {
		...
		$description = ! empty( $description ) ? $description : $this->get_shipping_method_option( $shipping_rate, 'dintero_description' );
	...
	public function get_shipping_address() {
		...
		$phone = ! empty( $phone ) ? $phone : WC()->customer->get_billing_phone();
		if ( ! empty( $phone ) ) {
